...
namespace Prohix.Infrastracture.Migrations
{
    ...
    [Migration("20230731080653_identity1")]
            ...
            modelBuilder.Entity("Prohix.Core.Entities.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e75bbc2c-c057-4e4e-8301-778e1bc3f5e9"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("8b3158fb-0afa-4708-a8d9-aa24fa19782d"),
                            Name = "Teacher"
                        },
                        new
                        {
                            Id = new Guid("ec46f5f6-7c46-4c69-82de-a6fa5f7bbd42"),
                            Name = "Student"
                        });
                });
