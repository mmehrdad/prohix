...
namespace Prohix.Infrastracture.Migrations
{
    ...
    [Migration("20230731084518_identity2")]
            ...
            modelBuilder.Entity("Prohix.Core.Entities.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d84cd155-702c-4e41-85ba-1e5a1e446e9f"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("74140121-7bb1-4079-90e5-85cc90f443aa"),
                            Name = "Teacher"
                        },
                        new
                        {
                            Id = new Guid("a0f1aae2-f987-41bd-a9f3-2c2cb78fecb9"),
                            Name = "Student"
                        });
                });
