...
namespace Prohix.Infrastracture.Migrations
{
    ...
    [Migration("20230808054037_student-scond")]
    partial class studentscond
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Prohix.Core.Entities.Students.Student", b =>
                {
                    ...
                    b.Property<long?>("SecondCitizenshipId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SecondCitizenshipId")
                        .IsUnique()
                        .HasFilter("[SecondCitizenshipId] IS NOT NULL");
            ...
            modelBuilder.Entity("Prohix.Core.Entities.Students.Student", b =>
                {
                    ...
                    b.HasOne("Prohix.Core.Entities.Commons.Country", "SecondCitizenship")
                        .WithOne("StudentCitizenship")
                        .HasForeignKey("Prohix.Core.Entities.Students.Student", "SecondCitizenshipId")
                        .OnDelete(DeleteBehavior.NoAction);
